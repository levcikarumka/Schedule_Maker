...
class TimetableScreen():
    def __init__ (self, root, mainframe, client, scheduleLoginframe, title_label, tt_client, f):
        ...
        tuesday_label = Label(self.timetable_contentframe, text="Tuesday", font=("Ariel", 14), bg="#90EE90", fg='red', width=20)
        wednesday_label = Label(self.timetable_contentframe, text="Wednesday", font=("Ariel", 14), bg="#90EE90", fg='red', width=20)
        thursday_label = Label(self.timetable_contentframe, text="Thursday", font=("Ariel", 14), bg="#90EE90", fg='red', width=20)
        friday_label = Label(self.timetable_contentframe, text="Friday", font=("Ariel", 14), bg="#90EE90", fg='red', width=20)
        saturday_label = Label(self.timetable_contentframe, text="Saturday", font=("Ariel", 14), bg="#90EE90", fg='red', width=20)
        sunday_label = Label(self.timetable_contentframe, text="Sunday", font=("Ariel", 14), bg="#90EE90", fg='red', width=20)

        to_login_label = Label(self.timetable_contentframe, text="Back to entering a schedule", font=("Ariel", 14), bg="#90EE90", fg='red', width=40)
        ...
        for i in range(1, 13):
            for j in range(0, 14):
                if j % 2 == 0:
                    btn_text = str((i - 1)) + ":00-" + str((i - 1)) + ":59"
                else:
                    btn_text = str((i + 11)) + ":00-" + str((i + 11)) + ":59"
