...
class ScheduleRegisterScreen():
    def __init__ (self, root, mainframe, client, scheduleloginframe, title_label, f):
        ...
        self.scheduleRegister_contentframe = Frame(self.scheduleRegisterframe, padx=15, pady=15, bg="white")

        self.title_label_reg = Label(self.scheduleRegister_contentframe, text="Title:", font=("Ariel", 14), bg="white")
        self.password_label_reg = Label(self.scheduleRegister_contentframe, text="Password:", font=("Ariel", 14), bg="white")
        self.confirm_password_label_reg = Label(self.scheduleRegister_contentframe, text="Repeat password:", font=("Ariel", 14), bg="white")

        self.title_entry_reg = Entry(self.scheduleRegister_contentframe, borderwidth=2, font=("Ariel", 14))
        self.password_entry_reg = Entry(self.scheduleRegister_contentframe, borderwidth=2, font=("Ariel", 14), show='*')
        self.confirm_password_entry_reg = Entry(self.scheduleRegister_contentframe, borderwidth=2, font=("Ariel", 14), show='*')

        self.see_password_button_reg = Button(self.scheduleRegister_contentframe, text="show", bg="white")

        register_button = Button(self.scheduleRegister_contentframe, text="Create", font=("Ariel", 16), bg="pink", fg="#fff", padx=25, pady=10, width=25)

        to_login_label = Label(self.scheduleRegister_contentframe, text="Have a schedule? Login now!", font=("Ariel", 14), bg="white", fg='red')
